...
def test_enable_disable_switch(freestyle):
    ...
    is_enable = freestyle.find_element(
    ...
    is_enable.click()
    is_disable = freestyle.find_element(
        By.CLASS_NAME, "jenkins-toggle-switch__label__unchecked-title"
    )
...
def test_disabled_message(disabled_message):
    warning_message = disabled_message.find_element(
