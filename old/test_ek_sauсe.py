...
def test_remove_from_cart(clean_cart):
    ...
    removed_cart = clean_cart.find_element(
        By.XPATH, "//div[contains(@class, 'removed_cart_item')]"
    )
